...
bindsym $mod+d exec rofi -modi run -show drun -show-icons -font "Cascadia Code 20"
bindsym $mod+Tab exec rofi -show window -show-icons -font "Cascadia Code 20"
...
bar {
        ...
        colors {
                background #374151
                separator #fbbf24
                focused_workspace  #10b981 #059669 #f3f4f6
...
client.focused #8b5cf6 #8b5cf6 #8b5cf6 #8b5cf6
for_window [class="^.*"]  border pixel 3
new_window pixel 3
exec picom
exec dunst
exec xrandr --output HDMI-2 --left-of eDP-1
exec feh --bg-fill --randomize ~/Pictures/*.jpg
for_window [class="Spotify"] move to workspace $ws10
for_window [class="Google-chrome-unstable"] move to workspace $ws2
for_window [class="Insomnia"] move to workspace $ws5
